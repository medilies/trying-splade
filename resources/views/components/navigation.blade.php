            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link href="{{ route('wilayas.index') }}" :active="request()->routeIs('wilayas.index')">
                            {{ __('Wilayas') }}
                        </x-nav-link>

                        <x-nav-link href="{{ route('class_types.index') }}" :active="request()->routeIs('class_types.index')">
                            {{ __('Class types') }}
                        </x-nav-link>
